 ...
 */
final class Version20220408073507 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE traduction_target ADD traducteur_id INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE traduction_target DROP traducteur_id, CHANGE lang_code lang_code VARCHAR(5) NOT NULL COLLATE `utf8_unicode_ci`, CHANGE traduction traduction LONGTEXT NOT NULL COLLATE `utf8_unicode_ci`');
